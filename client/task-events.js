const labels = {
  ...
  TaskRetryBudgetExhausted: '重试预算已耗尽', QuotaRecoveryScheduled: '已计划额度恢复', QuotaRecoveryResumed: '额度已恢复，已自动继续执行', TaskInterrupted: '节点已中断', TaskAttemptSuperseded: '尝试已被新修订取代', TaskReady: '节点已就绪', TaskAttemptStarted: '节点开始执行', AttemptProgressRecorded: '节点进度更新', TaskAttemptTimedOut: '节点执行超时', TaskRetryScheduled: '已计划重试', TaskAttemptSessionRecorded: '已记录子会话', ArtifactProduced: '已产出产物', EvidenceRecorded: '已记录证据', TaskRecoveryBlocked: '恢复受阻', GoalSucceeded: '任务成功',
}
