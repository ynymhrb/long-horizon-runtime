export interface GraphInputNode { id: string; objective: string; summary?: string; dependsOn?: readonly string[]; state: string }
...
export function taskNodeLabelPresentation(node: Pick<GraphInputNode, 'objective' | 'summary'>): { label: string; title: string }
