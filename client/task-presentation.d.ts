...
export function quotaRecoveryPresentation(recovery: { retryAt: string; diagnostic: string } | undefined, now?: Date, latestRecoveryEvent?: { type?: string }): { tone: string; label: string } | undefined
